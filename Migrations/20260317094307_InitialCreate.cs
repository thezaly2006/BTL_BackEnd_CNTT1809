        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipCardNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PTSchedules", x => x.ScheduleID);
                    table.ForeignKey(
                        name: "FK_PTSchedules_Members_MemberID",
                        column: x => x.MemberID,
                        principalTable: "Members",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PTSchedules_PersonalTrainers_PTID",
                        column: x => x.PTID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PTSchedules_MemberID",
                table: "PTSchedules",
                column: "MemberID");

            migrationBuilder.CreateIndex(
                name: "IX_PTSchedules_PTID",
                table: "PTSchedules",
                column: "PTID");
        }

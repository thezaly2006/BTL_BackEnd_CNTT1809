...
namespace GymManagement.Controllers
{
    public class MembershipTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MembershipTypeID,TypeName,DurationDays,Price,Description,CreatedAt")] MembershipType membershipType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MembershipTypeID,TypeName,DurationDays,Price,Description,CreatedAt")] MembershipType membershipType)
        {
